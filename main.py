...
class MyLoginForm(FlaskForm):
    email = StringField(label='Email', render_kw={"size": "30"})  # Email field with size attribute
    password = PasswordField(label='Password', render_kw={"size": "30"})  # Password field with size attribute
